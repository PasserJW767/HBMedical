 ...
 */
@Controller
@RequestMapping("/Policies_regulations")
public class CulproDataController {
    @Autowired
    ...
    public String selectForPage(Model model,
        ...
        Page<CulproData> culproDataList = this.culproDataService.selectlaw(pageNum,3);
        for (CulproData regulation : culproDataList) {
        ...
        model.addAttribute("culproDataList", culproDataList);

        return "Policies_regulations/law";
    }
    ...
    public String selectRegulations(Model model,
        ...
        return "Policies_regulations/regulation";
    }
